...
def get_clusters(data,
    ...
    logger.info(f"Generating clusters with the following training features: {training_features}")
...
def get_cluster_centers(data,
                        ...
                        include_row_count_sum):
    if informational_features:
        logger.info(f"Calculating cluster centers with the following informational features: {informational_features}")
    ...
    if include_row_count_sum:
        ...
        cluster_centers['row_count_proportion'] = cluster_centers['row_count'] / len(data)
