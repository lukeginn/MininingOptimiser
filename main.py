...
def main():
    ...
    general_config, data_config, model_config, clustering_config, simulation_config, optimisation_config = setup()
    ...
    univariable_feature_importance_generator = UnivariableFeatureImportanceGenerator(model_config)
    ...
    simulation_generator = SimulationGenerator(model_config, clustering_config, simulation_config)
